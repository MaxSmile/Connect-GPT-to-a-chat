  ...
  return (
    ...
    >
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <p className="w-full max-w-md mx-auto text-center py-3 rounded-lg text-white bg-gradient-to-br from-blue-600 to-teal-500 hover:from-blue-600 hover:to-teal-400 shadow-lg px-4">
